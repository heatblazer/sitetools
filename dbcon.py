...
if __name__ == "__main__":
    ...
    try:
        psycopg2.connect()
        conn = psycopg2.connect(user="hive", 
                                host="10.164.76.246",
                                port="8888",
                                database="presto")
...
'''
Facebook capture Participants: 10.92.39.97 and 10.242.50.240 
WA capture participants: 10.92.121.52 and 10.92.39.97 
Skype capture participants: 10.247.0.79  and 10.92.39.97 
'''

'''
select access_protocol, type, access_user_name, ipv4, msisdn, json, start_time from controls18
where 1=1
	--msisdn = '359888123456'
	--ipv4 = '192.168.10.31'
